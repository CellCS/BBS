...
<div id="wp" class="wp">
    <div id="pt" class="bm cl">
        <div class="z"><a href="./" class="nvhm" title="<?php echo $title; ?>"><?php echo $title; ?></a><em>&raquo;</em><a href="index.php">Home</a><em>&raquo;</em><a href="admin_member_list.php">Administration Center</a><em>&raquo;</em><a href="admin_postlist">Public Post List</a><em>&raquo;</em>Add Post</div>
    </div>
    <form method="post" autocomplete="off" id="postform" action="admin_addc.php" enctype="multipart/form-data">
